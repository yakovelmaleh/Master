        ...
        for ratio in ratio_lst:
            ...
            if jira_name == 'Nothing':
                model = TFBertForSequenceClassification.\
                    from_pretrained(f'YakovElm/{jira_name}{k_unstable}Classic_Train_Balance_DATA_ratio_{ratio_name}')
                ...
                model.push_to_hub(f"YakovElm/{jira_name}{k_unstable}Classic_Train_Balance_DATA_ratio_{ratio_name}")
            ...
            results = add_new_threshold(results, model, jira_name, main_path, k_unstable, predictions, test_input_ids,
                                        test_attention_mask, test_labels, 0.998, size, ratio_name)
