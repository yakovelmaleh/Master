...
Runs all unstable levels **5, 10, 15, 20** by default (four jobs). Uses the
...
Outputs are under this task's `cluster_runs/<run-id>/<project>/words_<level>/`,
with `results/verification_manifest.json`, model artifacts, and
