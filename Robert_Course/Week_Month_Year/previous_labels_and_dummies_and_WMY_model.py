...
import Robert_Course.Week_Month_Year.Data_Preparation as Previous_labels
...
def run(main_path, jira_name):
    main_path = f'{main_path}Robert_Course/Week_Month_Year/'
    run_N_previous_Model(jira_name, main_path, 50)
